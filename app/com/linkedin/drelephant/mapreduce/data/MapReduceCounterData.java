...
public class MapReduceCounterData {
    ...
    public static enum CounterName {
        ...
        BYTES_IN_REMOTE_RESULTS(GroupName.Hbase, "BYTES_IN_REMOTE_RESULTS", "hbaseBytesReadRemote"),
        BYTES_IN_RESULTS(GroupName.Hbase, "BYTES_IN_RESULTS", "hbaseBytesRead"),
        MILLIS_BETWEEN_NEXTS(GroupName.Hbase, "MILLIS_BETWEEN_NEXTS", "hbaseMillisBetweenNexts"),
        REMOTE_RPC_CALLS(GroupName.Hbase, "REMOTE_RPC_CALLS", "hbaseRemoteRpcCalls"),
        RPC_CALLS(GroupName.Hbase, "RPC_CALLS", "hbaseRpcCalls"),
        ROWS_FILTERED(GroupName.Hbase, "ROWS_FILTERED", "rowsFiltered"),
        ROWS_SCANNED(GroupName.Hbase, "ROWS_SCANNED", "rowsScanned"),
